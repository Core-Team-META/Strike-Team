...
local propEvilFailureLowBrassMusicLoopStingerKit01 = script:GetCustomProperty("EvilFailureLowBrassMusicLoopStingerKit01"):WaitForObject()
...
propEvilFailureLowBrassMusicLoopStingerKit01:Play()
...
EaseUI.EaseX(propSliverRightBottom, 198.6, .40, EaseUI.EasingEquation.QUADRATIC, EaseUI.EasingDirection.INOUT)
EaseUI.EaseX(propSliverRightMiddle, 195, .44, EaseUI.EasingEquation.QUADRATIC, EaseUI.EasingDirection.INOUT)
EaseUI.EaseX(propSliverRightTop, 190.1, .48, EaseUI.EasingEquation.QUADRATIC, EaseUI.EasingDirection.INOUT)
